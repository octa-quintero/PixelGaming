    ...
    <div className={style.container}>
      <div className={style.content}>
        ...
        <h1 className={style.textInfo}>
          ...
          Agrega y elimina juegos cuando quieras! Experimenta la libertad de construir tu colección perfecta. 
          Para una experiencia sin restricciones explora nuestras opciones premium y lleva tu biblioteca al siguiente nivel.
        </h1>
        
        <div className={style.cards}>
          {favoriteGames.length === 0 ? (
            <div className={style.noGamesMessage}>
              <p>Regístrate para agregar juegos a tu biblioteca</p>
              <img src={Cat} alt="Cat"/>
            </div>
          ) : (
